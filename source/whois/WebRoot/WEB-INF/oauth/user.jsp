...
<%@ include file="/WEB-INF/oauth/taglib.jsp"%>
		...
		<table align="center" border="1" cellspacing="0" cellpadding="0" id="lt" style="text-align: center;">
			...
			<c:forEach var="lists" items="${list }">
				...
				<tr >
					...
					<td>
						<a href="${ctx }/UserManageServlet.do?queryType=update&id=${lists.id }" style="text-decoration: none;">&nbsp;&nbsp;修改</a>&nbsp;&nbsp;&nbsp;
						<a href="${ctx }/UserManageServlet.do?queryType=delete&id=${lists.id }" style="text-decoration: none;">删除&nbsp;&nbsp;</a>
						
						<a href="${ctx }/AppServlet.do?queryType=list&user_id=${lists.id }" style="text-decoration: none;">设置APP&nbsp;&nbsp;</a>
					</td>
			...
			<tr>
				<td style="width: 100px;height: 40px;">
					<a href="${ctx }/UserManageServlet.do?queryType=add">添加</a>
				</td>
			</tr>
