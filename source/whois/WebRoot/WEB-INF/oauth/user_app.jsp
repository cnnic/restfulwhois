		...
		<table align="center" border="1" cellspacing="0" cellpadding="0" id="lt" style="text-align: center;">
			...
			<c:forEach var="lists" items="${list }">
				<tr >
					...
					<td>
						<a href="${ctx }/AppServlet.do?queryType=update&id=${lists.id }&user_id=${user_id}" style="text-decoration: none;">&nbsp;&nbsp;修改</a>&nbsp;&nbsp;&nbsp;
						<a href="${ctx }/AppServlet.do?queryType=delete&id=${lists.id }&user_id=${user_id}" style="text-decoration: none;">删除&nbsp;&nbsp;</a>
					</td>
			...
			<tr>
				<td style="width: 100px;height: 40px;">
					<a href="${ctx }/AppServlet.do?queryType=add&user_id=${user_id}">添加</a>
				</td>
			</tr>
