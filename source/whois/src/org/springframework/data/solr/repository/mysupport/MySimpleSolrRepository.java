package org.springframework.data.solr.repository.mysupport;
 ...
 */
public class MySimpleSolrRepository<T, ID extends Serializable> implements SolrCrudRepository<T, ID> {
	 ...
	 */
	public MySimpleSolrRepository(SolrOperations solrOperations) {
	 ...
	 * @param solrOperations must not be null
	 */
	public MySimpleSolrRepository(SolrEntityInformation<T, ?> metadata, SolrOperations solrOperations) {
		this(solrOperations);
	 ...
	 * @param entityClass
	 */
	public MySimpleSolrRepository(SolrOperations solrOperations, Class<T> entityClass) {
		this(solrOperations);
	...
	private ParameterizedType resolveReturnedClassFromGernericType(Class<?> clazz) {
		...
		if (genericSuperclass instanceof ParameterizedType) {
			...
			if (MySimpleSolrRepository.class.equals(rawtype)) {
